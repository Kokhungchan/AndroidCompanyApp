...
// swipe controller for swipe to delete in History.class
...
public class SwipeController extends Callback {
   ...
   @Override
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        RectF rightButton = new RectF(itemView.getRight() - buttonWidthWithoutPadding, itemView.getTop()+13, itemView.getRight()-13, itemView.getBottom()-13);
